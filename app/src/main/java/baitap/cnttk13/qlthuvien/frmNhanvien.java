...
class xuatnv {
    ...
    public String toString() {
        String kq = "";
        kq += "Mã nhanvien: " + this.manv + " | ";
        kq += "Tên nhan vien: " + this.tennv + "\n";
        kq += "email: " + this.email + "\n";
        kq += "sdt: " + this.sdt + "\n";
        kq += "Mật khẩu nv: " + this.mknv + "\n";
        return kq;
    }
}
...
public class frmNhanvien extends AppCompatActivity {
    ...
    EditText manv,tennv,email,mknv, sdt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hthinv=(ListView)findViewById(R.id.hthinv);
    ...
    public void them()
    {
        ...
        String sql="INSERT INTO NHANVIEN (MANV ,TENNV ,EMAIL ,SODT, MATKHAUNV )VALUES ('"+maNV+"','"+tenNV+"' ,'"+Email+"','"+Sdt+"','"+mkNV+"' )";
        try {
